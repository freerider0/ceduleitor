...
public class Diagnostics {
    ...
    public func computeConstraintSensitivity() -> [String: Double] {
        var sensitivities: [String: Double] = [:]
        let constraints = getAllConstraints()
        ...
        for constraint in constraints {
            ...
            sensitivities[String(describing: constraint)] = sensitivity
        }
        
        return sensitivities
    }
    
    public func computeParameterSensitivity() -> [String: Double] {
        var sensitivities: [String: Double] = [:]
        ...
        for param in parameters {
            ...
            sensitivities[String(describing: param)] = sensitivity
        }
