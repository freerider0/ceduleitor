...
// ================================================================================
// MARK: - Improved Room Capture View
// ================================================================================

struct RoomCaptureViewImproved: View {
                                ...
                                if detector.capturedWallsCount > 0 {
                                    HStack(spacing: 4) {
                                        Image(systemName: "rectangle.split.3x1")
                                            .font(.caption)
                                        Text("\(detector.capturedWallsCount) wall\(detector.capturedWallsCount == 1 ? "" : "s")")
                                            .font(.caption2)
                                    }
...
struct OnboardingTip: View {
    ...
    var tipText: String {
        ...
        case .wallIntersection:
            return "💡 Look at walls to detect them, then capture two perpendicular walls"
        }
    }
